...
/**
 * 文档地址：http://10.12.52.224:3000/project/59/interface/api/646
 * 生成日期：Fri Jan 15 2021 14:16:14 GMT+0800 (GMT+08:00)
 * 生成工具版本：node-v0.1
 * 接口名称：首页-企业精查客户（总部、区总、总、经、商）-王志军
 */
...
export interface ExactCustomerVo {
  ...
  stage:string                                       //客户阶段
  explain:null                                       //说明
  canClue:number                                     //是否可转线索，转线索接口是http://10.12.52.224:3000/project/59/interface/api/654
...
线索转客户：http://10.12.52.224:3000/project/59/interface/api/650
  custState:number                                   //1是线索转客户，2是客户池转客户
...
export default (params: Params)=> { 
    return request({
        url:'/entwxapi/customer/exactQueryNew',
        method:'GET',
        params:params
    })
}