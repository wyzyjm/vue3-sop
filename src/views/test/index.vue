<template>
  <el-container :style="{height:`${height}px`}">
    <el-header height="50px" style="text-align: right; font-size: 12px;background:#343434;color:#fff">
      <a class="logo">
    ...
    <el-container>
      <el-aside :style="{height:`${height-60}px`}" width="220px" style="background:#4d4d4d">
        <el-menu :default-openeds="['1', '3']" background-color="#4d4d4d" text-color="#fff">
          <el-submenu index="1">
      ...
      <el-main :style="{height:`${height-60}px`}">
